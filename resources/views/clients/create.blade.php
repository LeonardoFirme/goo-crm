...
<x-app-layout title="Novo Cliente" subtitle="Cadastre um novo cliente ou lead para iniciar o relacionamento">
                    ...
                    <form method="POST" action="{{ route('clients.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text"
                                    class="mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm" placeholder="Nome do completo do cliente ou razão social da empresa..."
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email"
                                    class="mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm" placeholder="E-mail principal para contato e envio de faturas..."
                            ...
                            <div>
                                ...
                                <x-text-input id="tax_id" name="tax_id" type="text"
                                    class="mask-tax-id mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm font-mono"
                                    :value="old('tax_id')" required placeholder="000.000.000-00" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text"
                                    class="mask-phone mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm"
                            ...
                            <div>
                                ...
                                <x-text-input id="website" name="website" type="url"
                                    class="mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm"
                                    :value="old('website')" placeholder="https://exemplo.com.br" />
                            ...
                            <div x-data="{
                                ...
                                selectedValue: '{{ old('status', 'lead') }}',
                                get selectedName() { return this.statusMap[this.selectedValue] }
                            }">
                                <x-input-label :value="__('Status inicial')"
                                    class="text-sm font-medium text-gray-700" />
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="4"
                                class="mt-1 block w-full border-gray-300 focus:border-gray-900 focus:ring-gray-900 rounded-lg shadow-sm text-sm"
                                placeholder="Notas estratégicas sobre o cliente...">{{ old('notes') }}</textarea>
                        ...
                        <div class="flex items-center justify-end gap-6 pt-6 border-t border-gray-100">
                            ...
                            <x-primary-button class="px-10 py-3">{{ __('Salvar cliente') }}</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
